...
- (id)initWithSessionPreset:(NSString *)sessionPreset cameraPosition:(AVCaptureDevicePosition)cameraPosition; 
{
    ...
    if ([GPUImageVideoCamera supportsFastTextureUpload])
    {
        ...
        CVReturn err = CVOpenGLESTextureCacheCreate(kCFAllocatorDefault, NULL, CFBridgingRelease((__bridge void *)[[GPUImageOpenGLESContext sharedImageProcessingOpenGLESContext] context]), NULL, &coreVideoTextureCache);
        if (err) 
        {
